...
langbutton[4] = "sclick......";
langbutton[5] = "Hdclick..,,.";
langbutton[6] = "lpress......";
langbutton[7] = "Relay connection - Здесь указаны пины одного реле или несколько с которыми взаимодействует данная кнопка.";
langbutton[8] = "INFO - Укажите название данной кнопки для быстрой навигации на пример \"Кухня\", \"Детская\" и т.д. Не более 30-ти символов!";
langbutton[9] = "On/Off - \"Вкл\"\"Откл\" данный пин/выключатель.";
langbutton[10] = "Action - Возможные действия с данным пином.";
...
langpwm[1] = "ID - уникальный числовой идентификатор пина. Присваивается автоматически";
langpwm[2] = "Pin - Уникальный номер цифрового или аналогового пина.";
langpwm[3] = "PWM frequency (Hz) - частота ШИМ в герцах. Если 0 - то ШИМ не используется.";
langpwm[4] = "On - состояние выхода - 1-вкл, 0-откл.";
langpwm[5] = "Invert State - инверсия порта (Выкл - на выходе логическая 1, вкл - 0).";
langpwm[6] = "Dimmer value - если используется ШИМ - его скважность (0-255).";
langpwm[7] = "PowerOn Restore - какие параметры нужно сохранять при изменении и восстановить при включении контроллера None - ничего не сохранять, при включении состояние и значение равны установленным при конфигурировании. State - восстанавливать последнее установленное состояние параметра On. Value - восстанавливать последнее установленное значение диммера (ШИМ). State&Value - восстанавливать состояние и значение.";
langpwm[8] = "INFO - Дайте название выбранному реле для быстрой навигации на пример \"Кухня\", \"Детская\" и т.д. Не более 30-ти символов!";
langpwm[9] = "On/Off - \"Вкл\"/\"Откл\" данное реле.";
langpwm[10] = "Action - Возможные действия с данным пином.";
...
var langz = new Array();
langz[1] = "ID - уникальный числовой идентификатор пина. Присваивается автоматически";
langz[2] = "Pin - Уникальный номер цифрового или аналогового пина.";
langz[3] = "INFO - Дайте название выбранному реле для быстрой навигации на пример \"Кухня\", \"Детская\" и т.д. Не более 30-ти символов!";
langz[4] = "On/Off - \"Вкл\"/\"Откл\" данное реле.";
langz[5] = "Action - Для себя, запишите напоминание для чего этот пин!.";
...
lange1Wire[1] = "ID - уникальный числовой идентификатор cron. Присваивается автоматически.";
lange1Wire[2] = "Pin - Уникальный номер цифрового или аналогового пина.";
lange1Wire[3] = "Sensor - Здесь указан какой датчик подключен к данному пину.";
lange1Wire[4] = "Укажите количество подключаемых устройств ds18b20.";
lange1Wire[5] = "Установите верхний предел температуры C° (ds18b20 -55°C to +125°C).";
lange1Wire[6] = "Укажите какое действие необходимо выполнить при достижении верхнего предела температуры.";
lange1Wire[7] = "Установите нижний предел температуры C° (ds18b20 -55°C to +125°C).";
lange1Wire[8] = "Укажите какое действие необходимо выполнить при достижении нижнего предела температуры.";
lange1Wire[9] = "INFO - Дайте название выбранному таймеру для быстрой навигации на пример \"Полив газона\", \"Свет во дворе\" и т.д. Не более 30-ти символов!";
lange1Wire[10] = "ON - State of pin -1 is 'On', 0 is 'Off'.";
lange1Wire[11] = "Action - Возможные действия с данным пином.";