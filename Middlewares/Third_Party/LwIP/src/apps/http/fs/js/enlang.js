...
langbutton[5] = "dclick...";
langbutton[6] = "lpress...";
langbutton[7] = "Relay connection - Here will appear one or more relays of pin(s) with which this button interacts.";
langbutton[8] = "INFO - Give a name of this button for quick navigation. Example: \"Kitchen\", \"Children room\", etc. Max. 30 characters!";
langbutton[9] = "On/Off - 'On' or 'Off' this pin/switch.";
langbutton[10] = "Action - Some actions with this pin.";
