...
#define _DS18B20_MAX_SENSORS		    125 // Укажи количество ds18b20! 1=17ms а 3шт=40ms, 6шт=74ms.   125шт примерно 1662,66 мс (или около 1,66 секунды)
#define	_DS18B20_GPIO					PinsInfo[i].gpio_name
#define	_DS18B20_PIN					PinsInfo[i].hal_pin
